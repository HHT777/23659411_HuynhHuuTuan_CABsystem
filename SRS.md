...
> \*\*Phiên bản rà soát ngày 23/09/2026.\*\* Giữ cấu trúc và các bảng của tài liệu gốc. Yêu cầu được trích từ Công ty ABC được phân biệt với \*\*baseline dự án\*\* (thông số do nhóm tự quyết để xây dựng bản thí điểm 7 tuần). Công ty ABC chưa phê duyệt các thông số này. Mục 05.IV, 08.V, 10.I, 12.9, 16.4 và 18.9 là các bảng chính sách áp dụng khi các bước phân tích trước đó còn ghi “cần làm rõ”. Các bảng ghi nhận nguồn/chưa rõ ở bước 02–04 phản ánh \*\*thời điểm thu thập ban đầu\*\*, không phải trạng thái cuối cùng. Không coi API cho đối tác thanh toán thật đã chốt nếu chưa chọn nhà cung cấp.
...
## IV. Chính sách đã chọn cho BR cần làm rõ

### Quyết định nghiệp vụ giả định cho bản triển khai 7 tuần (23/09/2026)

**Trạng thái:** Đề xuất được nhóm dự án chọn làm baseline để thiết kế và kiểm thử; chưa phải xác nhận từ Công ty ABC. Các quyết định dưới đây có hiệu lực ưu tiên khi mục cũ trong SRS còn ghi `\[Cần làm rõ]` cho cùng vấn đề. Nếu thay đổi baseline, cập nhật đồng bộ BP, FR, BRULE, EX, NFR, UC, AC, RTM và API.
...
| BR-09, BR-10, BR-12 | Chọn tài xế đang sẵn sàng, chưa có chuyến, cùng loại xe, vị trí hợp lệ trong bán kính 5 km từ điểm đón; xếp theo khoảng cách tăng dần, hòa thì theo thời điểm cập nhật vị trí mới hơn, sau đó ID tăng dần. Mỗi lần chỉ gửi một lời mời; tài xế có 20 giây phản hồi. Khi từ chối/hết hạn, gửi tài xế kế tiếp; tối đa 10 tài xế hoặc 3 phút, điều kiện nào đến trước.                                                                                                         | Chấp nhận đầu tiên hợp lệ được ghi nhận nguyên tử; phản hồi muộn hoặc trùng bị từ chối; hết ứng viên/thời gian chuyển trạng thái không tìm được tài xế và báo khách.                                                                                                                                           |
| BR-04, BR-14        | Khi trực tuyến hoặc thực hiện chuyến, ứng dụng tài xế gửi tọa độ WGS84 tối đa 10 giây/lần; chỉ dùng vị trí cập nhật trong 60 giây để điều phối. Khách hàng thấy vị trí gần nhất và giờ cập nhật. ETA đến điểm đón = thời lượng tuyến từ vị trí gần nhất nếu dịch vụ bản đồ khả dụng; nếu không có tuyến, hiển thị “Chưa có ETA”, không bịa thời gian.                                                                                                                       | Không dùng vị trí cũ quá 60 giây để mời chuyến. Chỉ khách của chuyến và vận hành có quyền mới xem vị trí chuyến; ngừng chia sẻ vị trí trực tiếp sau khi kết thúc/hủy.                                                                                                                                          |
| BR-13               | Trạng thái chuyến: `đã phân công → đã đến điểm đón → đã đón khách → đang di chuyển → hoàn thành`; hủy trước khi đã đón khách bởi khách hoặc tài xế, có lý do; từ mốc đã đón khách chỉ vận hành được xử lý sự cố/hủy có ghi vết.                                                                                                                                                                                                                                             | Không cho nhảy lùi/bỏ qua trạng thái; chuyến hoàn thành không thể hủy; bản 7 tuần chưa áp dụng phí hủy.                                                                                                                                                                                                        |
| BR-15               | Tiền tệ VND. Giá xe máy = 10.000đ mở cửa (2 km đầu) + 4.000đ/km tiếp theo; ô tô 4 chỗ = 25.000đ mở cửa (2 km đầu) + 10.000đ/km tiếp theo. Quãng đường tính theo tuyến thực tế được chốt khi hoàn thành; nếu thiếu dữ liệu tuyến, dùng khoảng cách tuyến dự kiến tại lúc đặt xe và gắn cờ vận hành kiểm tra. Làm tròn lên bội số 1.000đ sau khi tính.                                                                                                                        | Hiển thị giá ước tính trước khi đặt và tiền thực trả sau chuyến; không áp dụng phụ phí giờ cao điểm, phí chờ, mã giảm giá, thuế/phí tách riêng trong phiên bản này. Giá được lưu theo phiên bản biểu giá tại thời điểm đặt, không đổi ngược lịch sử.                                                           |
| BR-16, BR-17, BR-20 | Hỗ trợ tiền mặt và một cổng thanh toán điện tử ở môi trường thử nghiệm, cấu hình nhà cung cấp qua adapter; chưa chọn tên thương mại. Không lưu số thẻ, CVV, mật khẩu thanh toán. Chỉ đánh dấu thanh toán thành công sau kết quả xác thực từ cổng; callback trùng xử lý một lần. Nếu thất bại/không xác định, giữ `chưa thanh toán`, tra cứu kết quả trước khi cho thử lại; khách được thử lại tối đa 2 lần hoặc chuyển sang tiền mặt khi chưa có giao dịch thành công.      | Không ghi nhận hai lần thu cho một chuyến; trạng thái `chờ xử lý/đã thanh toán/thất bại/chưa xác định`; thanh toán tiền mặt do tài xế xác nhận nhận tiền, vận hành có thể xem và xử lý tranh chấp có lưu vết. Tích hợp thật phụ thuộc tài khoản/contract của đối tác; bản đồ án dùng sandbox/mock nếu chưa có. |
| BR-18, BR-19        | Thông báo trong ứng dụng là kênh bắt buộc; sự kiện: tiếp nhận yêu cầu, mời tài xế, phân công, tài xế đến, hoàn thành, hủy, không tìm được tài xế, kết quả thanh toán. Nếu người dùng đang dùng ứng dụng, cập nhật màn hình gần thời gian thực; khi mất kết nối, đọc lại thông báo khi mở ứng dụng.                                                                                                                                                                          | Ghi một thông báo theo cặp `(người nhận, sự kiện nghiệp vụ)`; gửi lại nội bộ tối đa 3 lần cách nhau tăng dần, lỗi thông báo không đảo ngược trạng thái chuyến. SMS/email/push là giai đoạn sau.                                                                                                                |
...
| BR-26, BR-30        | Ưu tiên trong 7 tuần: đặt xe và điều phối → chuyến/vị trí → cước/thanh toán thử nghiệm → vận hành/báo cáo/bảo mật. Phân tách hợp đồng nghiệp vụ điều phối, thanh toán và thông báo để có thể thay adapter hoặc tăng tài nguyên xử lý độc lập; chưa cam kết microservices, nhiều vùng, hoặc triển khai không gián đoạn.                                                                                                                                                      | Có thể thay cổng thanh toán mock bằng sandbox khác và bổ sung kênh thông báo qua adapter mà không thay quy tắc chuyến; triển khai cập nhật không làm mất giao dịch đã ghi nhận.                                                                                                                                |
| BR-27, BR-28, BR-29 | Người dùng đăng nhập để truy cập dữ liệu riêng; mật khẩu lưu dạng hash có salt, kết nối mã hóa TLS, quyền theo vai trò và quyền sở hữu. Chỉ giữ vị trí chi tiết của chuyến 30 ngày; lịch sử chuyến/giao dịch 24 tháng; audit 12 tháng trong phạm vi bản thí điểm, sau đó xóa/ẩn danh theo chính sách dữ liệu áp dụng.                                                                                                                                                       | Audit đăng nhập thất bại, thay đổi quyền/biểu giá, khóa tài xế, đổi trạng thái chuyến, kết quả thanh toán, xử lý sự cố; không ghi mật khẩu, token, thông tin thẻ hay tọa độ chi tiết vào audit. Chính sách lưu giữ thực tế cần rà soát nghĩa vụ pháp lý trước triển khai thương mại.                           |
...
**Nguồn tham khảo thiết kế:** OWASP ASVS cho kiểm soát truy cập và lưu vết; tài liệu nhà cung cấp thanh toán về idempotency; API định tuyến về thời lượng/khoảng cách. Các con số giá, tải, thời gian chờ, retention và công thức báo cáo trong bảng là **giả định dự án**, không trích từ nguồn ngoài và không được ghi là khách hàng đã xác nhận.
...
### Business Requirement có baseline dự án

Chính sách chi tiết cho các BR trước đây cần làm rõ được chọn tại mục IV. Đây là giả định của nhóm phục vụ đồ án; nhà cung cấp thanh toán thương mại và chính sách triển khai thật vẫn phải được doanh nghiệp phê duyệt.
...
| FR-02 | Hệ thống cho phép tài xế tự gửi thông tin tài khoản, hồ sơ và phương tiện để đăng ký; đăng ký phải được xét duyệt trước khi nhận chuyến. | BR-07 | BP-01 | STEP-01 | STK-02 | \[Đã xác nhận] |
| FR-03 | Hệ thống cho phép nhân viên vận hành tra cứu và xét duyệt hồ sơ đăng ký hoặc yêu cầu thay đổi của tài xế theo quyền được cấp. | BR-07 | BP-01 | STEP-01, STEP-03 | STK-03 | \[Đã xác nhận]; thời hạn duyệt `TBD` |
...
| FR-05 | Hệ thống cho phép khách hàng cập nhật thông tin tài khoản chung.                                                       | BR-02                      | BP-01        | STEP-03          | STK-01                 | \[Đã xác nhận]                                                                                    |
| FR-06 | Hệ thống cho phép tài xế cập nhật thông tin tài khoản chung và trường nghiệp vụ thông thường; thay đổi giấy tờ/phương tiện chỉ có hiệu lực sau khi Vận hành duyệt; trạng thái xét duyệt, tài khoản và sẵn sàng phải tách biệt. | BR-07, BR-08 | BP-01 | STEP-03 | STK-02 | \[Đã xác nhận] |
...
| FR-32 | Hệ thống cho phép nhân viên vận hành tra cứu khách hàng, tài xế, phương tiện và chuyến đi; chỉ cập nhật trạng thái/tác vụ có căn cứ, không xóa dữ liệu hoặc sửa kết quả thanh toán. | BR-21, BR-23 | BP-07 | STEP-22 | STK-03 | \[Đã xác nhận phạm vi quyền pilot] |
...
| FR-34 | Hệ thống cho phép nhân viên vận hành tiếp nhận hỗ trợ chuyến lỗi và chỉ đọc lịch sử giao dịch; không chỉnh sửa kết quả thanh toán. | BR-22 | BP-07 | STEP-23 | STK-03 | \[Đã xác nhận]; chi tiết kết quả xử lý lỗi `TBD` |
...
| FR-37 | Hệ thống tổng hợp và cung cấp cho Ban lãnh đạo báo cáo số lượng chuyến, doanh thu, tỷ lệ hoàn thành và tỷ lệ hủy; chỉ số hiệu quả tài xế chưa công bố cho đến khi có công thức. | BR-24 | BP-08 | STEP-26 | STK-04, STK-05 | \[Đã xác nhận actor/phạm vi]; công thức hiệu suất và kỳ báo cáo `TBD` |
...
## V. Chính sách áp dụng cho Functional Requirement

| FR trong bảng gốc          | Chính sách áp dụng                                                                                                                                              | Nguồn và kiểm thử              |
| -------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------ |
| FR-03, FR-06, FR-31, FR-32 | Quyền theo năm vai trò và sở hữu bản ghi ở mục 05.IV; tài xế chỉ ONLINE khi hồ sơ/xe đang hoạt động, chưa có chuyến.                                            | BR-07/23; BC-13/16 ở mục 16.4. |
| FR-10, FR-11, FR-14        | Lọc trong 5 km, vị trí không quá 60 giây; ưu tiên khoảng cách, vị trí mới, ID; một lời mời 20 giây, tối đa 10 người/180 giây.                                   | BR-09/10; BC-02–05.            |
| FR-21                      | WGS84, nhận vị trí trong lúc trực tuyến/chuyến, tối đa 10 giây/lần; ETA lấy tuyến, thiếu tuyến hiển thị chưa có ETA.                                            | BR-04/14; BC-01/03.            |
...
| FR-25, FR-27               | Tiền mặt và một adapter sandbox/mock; callback xác thực, chống gửi trùng; UNKNOWN tra cứu trước, FAILED tối đa hai lần thử lại.                                 | BR-16/17/20; BC-09/15.         |
| FR-09, FR-15, FR-18, FR-26 | Kênh trong ứng dụng, ghi một thông báo/người nhận/sự kiện, retry nội bộ tối đa ba lần; lỗi không đảo ngược chuyến.                                              | BR-18/19; AC mục 16.1.         |
| FR-30                      | Chủ chuyến đánh giá một lần sau hoàn thành, điểm nguyên 1–5, trong 7 ngày tính cả thời điểm đúng hạn.                                                           | BR-06; BC-10.                  |
| FR-34, FR-35               | Nhân viên vận hành xử lý sự cố và ghi nhật ký; không sửa thanh toán thành công. Giữ vị trí chuyến 30 ngày, lịch sử 24 tháng, audit 12 tháng trong bản thí điểm. | BR-22/29; AC mục 16.1.         |
| FR-37, FR-38               | Ngày/tháng/khoảng ngày theo Asia/Ho_Chi_Minh; chỉ số/mẫu số ở mục 05.IV; tải thí điểm 30 yêu cầu/phút và 100 chuyến đồng thời.                                  | BR-24/25; BC-11/14.            |

**Trạng thái:** chính sách đã chọn cho bản thí điểm; cần cập nhật trực tiếp contract đối tác thật nếu dùng nhà cung cấp thật. Các bảng trước mục này là truy xuất chức năng gốc, không thay đổi mã FR.
...
### 10.I.a Quy tắc và xử lý ngoại lệ cụ thể theo baseline

| Rule    | Nội dung quyết định                                                                                                                                                | BR/FR                                 |
| ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------- |
| RULE-01 | Mỗi điện thoại chỉ thuộc một tài khoản; quyền và chủ sở hữu được kiểm tra ở máy chủ.                                                                               | BR-02, BR-27 / FR-01–03, FR-34        |
| RULE-02 | Một khách tối đa một yêu cầu/chuyến mở; một tài xế tối đa một chuyến mở.                                                                                           | BR-03, BR-08 / FR-05, FR-07–08, FR-13 |
| RULE-03 | Vị trí WGS84 hợp lệ, mới không quá 60 giây; 5 km là giới hạn có tính cả mốc 5.000 m.                                                                               | BR-09, BR-14 / FR-10, FR-15           |
| RULE-04 | Tài xế phản hồi trong 20 giây tính cả mốc đúng 20, tính theo thời gian máy chủ; giới hạn 10 ứng viên và 180 giây tính cả mốc; sự kiện đến sau thời hạn bị từ chối. | BR-10 / FR-11–14                      |
| RULE-05 | Chuyển trạng thái đúng thứ tự ở mục 3; hủy sau đón khách chỉ qua vận hành và có lý do.                                                                             | BR-13 / FR-16–17                      |
| RULE-06 | Giá mở cửa bao gồm tối đa 2.000 m; phần dư tính theo km thực, làm tròn tổng lên 1.000đ; dùng đúng phiên bản biểu giá khi đặt.                                      | BR-15 / FR-06, FR-19–20               |
| RULE-07 | Một chuyến có thể có nhiều lần thử điện tử nhưng tối đa một thanh toán thành công; trạng thái chưa xác định phải tra cứu, không thu tiếp.                          | BR-16, BR-17, BR-20 / FR-21–25        |
| RULE-08 | Một đánh giá/chuyến của khách sở hữu, điểm 1–5 nguyên, trong 7 ngày tính cả đúng hạn.                                                                              | BR-06 / FR-29                         |
| RULE-09 | Thống kê theo múi giờ Việt Nam, từ đầu kỳ bao gồm đến cuối kỳ loại trừ; mẫu số bằng 0 trả `null` với nhãn `N/A`.                                                   | BR-24 / FR-33                         |
| RULE-10 | Truy cập bị từ chối theo mặc định; không xuất dữ liệu nhạy cảm; lưu giữ theo mục 3.                                                                                | BR-23, BR-28, BR-29 / FR-30–34        |

| Ngoại lệ                                     | Kết quả bắt buộc                                                                          | FR                            |
| -------------------------------------------- | ----------------------------------------------------------------------------------------- | ----------------------------- |
| EX-01 Không xác thực/không quyền             | Trả lỗi, không thay đổi dữ liệu; không tiết lộ dữ liệu người khác.                        | FR-02, FR-34                  |
| EX-02 Thiếu/sai dữ liệu hoặc yêu cầu trùng   | Trả chi tiết trường sai hoặc xung đột; không tạo hai yêu cầu.                             | FR-01, FR-07–08               |
| EX-03 Không có tài xế/hết thời hạn           | Đổi yêu cầu thành `không tìm được`, thông báo khách một lần.                              | FR-10–14                      |
| EX-04 Phản hồi muộn hoặc xung đột hai tài xế | Máy chủ chỉ gán một tài xế; trả xung đột cho phản hồi còn lại.                            | FR-12–13                      |
| EX-05 Mất kết nối trước kết quả              | Client tra cứu bằng ID/khóa chống trùng, gửi lại cùng khóa nếu chưa có kết quả.           | FR-07, FR-12, FR-23–24, FR-29 |
| EX-06 Thiếu tuyến/ETA                        | Hiển thị `Chưa có ETA`; khi tính cước dùng khoảng cách dự kiến đã lưu và gắn cờ kiểm tra. | FR-18–20                      |
| EX-07 Thanh toán thất bại/không xác định     | Không đánh dấu đã trả; tra cứu giao dịch; chỉ cho thử lại khi đã xác định thất bại.       | FR-23–25                      |
| EX-08 Thông báo lỗi                          | Ghi hàng đợi gửi lại tối đa 3 lần; không hoàn tác chuyến.                                 | FR-26–27, FR-35               |
| EX-09 Báo cáo chưa có bản ghi                | Trả chỉ số 0 phù hợp và tỷ lệ `null`/`N/A`; không bịa doanh thu.                          | FR-33                         |
| EX-10 Dữ liệu vị trí cũ/sai                  | Không dùng điều phối; không cho vượt phạm vi dữ liệu chuyến.                              | FR-10, FR-15, FR-18           |

> `RULE-xx`/`EX-xx` ở bảng bổ sung dùng để viết test và API của baseline. Các mã `BRULE-xx`/`EX-xx` trong bảng gốc vẫn được giữ nguyên để truy xuất lịch sử; đối chiếu theo BR và nội dung nghiệp vụ, không giả định hai mã cùng số là một.
...
Tài liệu này nối tiếp chuỗi logic từ `SRS.md` (B1–B8) và `11\_XacDinhNonFunctionalRequirement\_NFR.md`, thực hiện lần lượt các bước:
...
> \*\*Quy ước ID:\*\* Để nhất quán với `SRS.md`, các mã nguồn được dùng nguyên dạng: `FR01`–`FR62`, `BR01`–`BR29`, `BR\_01`–`BR\_22` (Business Rule), `EX01`–`EX09`, `BP-01`–`BP-07`, `OI01`–`OI10`. Các mã mới sinh ở bước 12–16 dùng `ENT-xx`, `ACT-xx`, `UC-xx`, `AC-xx`.
...
```mermaid
erDiagram
    NGUOI\_DUNG ||--o| KHACH\_HANG : "có tài khoản"
    NGUOI\_DUNG ||--o| TAI\_XE : "có tài khoản"
    NGUOI\_DUNG ||--o| NHAN\_VIEN\_VAN\_HANH : "có tài khoản"
    TAI\_XE ||--o{ PHUONG\_TIEN : "sở hữu"
    KHACH\_HANG ||--o{ YEU\_CAU\_DAT\_XE : "tạo"
    YEU\_CAU\_DAT\_XE ||--o| CHUYEN\_DI : "tạo ra"
    TAI\_XE ||--o{ CHUYEN\_DI : "nhận"
    TAI\_XE ||--o{ VI\_TRI\_TAI\_XE : "cập nhật"
    CHUYEN\_DI ||--o| CUOC\_PHI : "có"
    CHUYEN\_DI ||--o{ THANH\_TOAN : "có"
    CHUYEN\_DI ||--o| DANH\_GIA : "có"
...
## 12.9 Dữ liệu và quyền cụ thể của baseline

| Thực thể       | Trường tối thiểu                                                                                                                                    | Bất biến                                                                                             |
| -------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| User           | `id` UUID, `phone` chuỗi E.164, `name` 1–100 ký tự, `passwordHash`, `role`, `status`, `createdAt` UTC                                               | `phone` duy nhất, không trả `passwordHash`.                                                          |
| Driver/Vehicle | `userId`, `vehicleId`, `vehicleType` enum `MOTORBIKE/CAR4`, `plate` 1–20 ký tự, `status` enum `ACTIVE/LOCKED`, `availability` enum `ONLINE/OFFLINE` | Xe và hồ sơ phải ACTIVE khi bật ONLINE.                                                              |
| RideRequest    | `id`, `customerId`, `pickup`, `destination`, `vehicleType`, `status`, `quotedFareVnd`, `priceVersion`, `createdAt`                                  | Khách có tối đa một yêu cầu tìm tài xế; báo giá lưu theo phiên bản.                                  |
| RideOffer      | `id`, `requestId`, `driverId`, `sentAt`, `expiresAt`, `status` `PENDING/ACCEPTED/DECLINED/EXPIRED`                                                  | Mỗi yêu cầu tối đa một offer PENDING.                                                                |
| Trip           | `id`, `requestId`, `driverId`, `status`, `startedAt`, `completedAt`, `cancelReason`, `distanceMeters`                                               | `requestId` duy nhất; trạng thái chỉ đổi theo RULE-05.                                               |
| DriverLocation | `driverId`, `latitude`, `longitude`, `receivedAt` UTC                                                                                               | Latitude trong \[-90,90], longitude trong \[-180,180]; nhận bản mới hơn, không dùng bản quá 60 giây. |
| Fare           | `tripId`, `fareVnd` số nguyên không âm, `distanceMeters`, `distanceSource` `ACTUAL/ESTIMATED`, `priceVersion`                                       | Một cước chốt/chuyến; làm tròn theo RULE-06.                                                         |
| Payment        | `id`, `tripId`, `method` `CASH/ELECTRONIC`, `status` `PENDING/SUCCEEDED/FAILED/UNKNOWN`, `providerReference`, `attemptNo`, `createdAt`              | Một lần thành công/chuyến; mã tham chiếu không phải dữ liệu thẻ.                                     |
| Notification   | `id`, `recipientId`, `eventId`, `type`, `createdAt`, `readAt`                                                                                       | Duy nhất `(recipientId,eventId)`.                                                                    |
| Rating         | `id`, `tripId`, `customerId`, `driverId`, `score` số nguyên 1–5, `createdAt`                                                                        | `tripId` duy nhất.                                                                                   |
| Incident/Audit | `incidentId`, `tripId`, `status`, `note`; audit có `actorId`, `action`, `resourceId`, `before/after` đã lược dữ liệu nhạy cảm, `occurredAt`         | Chỉ người có quyền xem; bất biến lịch sử.                                                            |

**Tọa độ:** object `{"latitude":10.0,"longitude":106.0}` với số hữu hạn; hai điểm phải khác nhau. **Thời gian:** ISO 8601 UTC trong API; báo cáo quy đổi Asia/Ho_Chi_Minh. **Tiền:** số nguyên VND, không dùng số thực cho tiền. **ID:** UUID do máy chủ tạo. **Lưu giữ:** theo mục 3; xóa/ẩn danh dữ liệu theo thời hạn áp dụng, không xóa bằng việc thay đổi giao dịch lịch sử.

**Trạng thái yêu cầu:** `SEARCHING → ASSIGNED/NO\_DRIVER/CANCELLED`; `ASSIGNED` tạo đúng một Trip. **Trạng thái chuyến:** `ASSIGNED → ARRIVED → PICKED\_UP → MOVING → COMPLETED`; nhánh `CANCELLED` trước `PICKED\_UP`, sau đó chỉ vận hành xử lý sự cố có audit. Không có chuyển trạng thái ngược hoặc tự động thanh toán khi `COMPLETED`.

| Thao tác                                                                        | Khách | Tài xế | Vận hành | Quản trị | Lãnh đạo |
| ------------------------------------------------------------------------------- | ----- | ------ | -------- | -------- | -------- |
| Xem/sửa hồ sơ riêng; đặt xe, xem chuyến riêng, trả tiền, đánh giá               | Có    | Không  | Không    | Không    | Không    |
| Xem hồ sơ/chuyến được giao; vị trí, sẵn sàng, phản hồi offer, xác nhận tiền mặt | Không | Có     | Không    | Không    | Không    |
| Xem hồ sơ/chuyến/giao dịch phục vụ hỗ trợ; khóa tài xế; xử lý sự cố             | Không | Không  | Có       | Có       | Không    |
| Cấp quyền vận hành, cập nhật giá mới                                            | Không | Không  | Không    | Có       | Không    |
| Xem báo cáo tổng hợp                                                            | Không | Không  | Không    | Có       | Có       |
...
| ACT-04   | Admin                | Quản lý              | Admin/quản trị        | Cấu hình, phân quyền và thao tác quản trị nhạy cảm | FR54/FR60/BR_18 | Đã xác nhận phạm vi API |
| ACT-05   | PaymentProvider      | Hệ thống bên ngoài   | Payment Provider      | Xử lý thanh toán điện tử                        | FR34/FR35/BR_12 | Đã xác nhận       |
| ACT-06   | NotificationProvider | Hệ thống bên ngoài   | Notification Provider | Gửi thông báo qua adapter nội bộ; không có webhook công khai trong pilot | FR38–FR43 | Đã xác nhận cho pilot |
| ACT-07   | BanLanhDao           | Người dùng báo cáo   | Ban lãnh đạo/Executive | Xem báo cáo hoạt động; không cấu hình hay quản trị hệ thống | FR55–FR58 | Đã xác nhận       |

## 13.3 Danh sách Use Case

| UC ID | Tên Use Case                 | Mục tiêu nghiệp vụ            | Actor                          | FR liên quan           | BP liên quan        | Rule/Exception                   | Trạng thái        |
| ----- | ---------------------------- | ----------------------------- | ------------------------------ | ---------------------- | ------------------- | -------------------------------- | ----------------- |
| UC-01 | Đăng ký tài khoản            | Khách hàng hoặc tài xế tự đăng ký; hồ sơ tài xế phải được duyệt trước khi nhận chuyến | ACT-01, ACT-02 | FR01, FR02 | BP-01 | BR_01 | Đã xác nhận       |
| UC-02 | Đăng nhập                    | Xác thực người dùng           | ACT-01, ACT-02, ACT-03, ACT-04 | FR03, FR59             | BP-01               | BR_01                            | Đã xác nhận       |
| UC-03 | Cập nhật thông tin cá nhân   | Sửa tài khoản chung; hồ sơ nghiệp vụ/xe của tài xế dùng yêu cầu thay đổi và xét duyệt | ACT-01, ACT-02 | FR04 | BP-01 | — | Đã xác nhận       |
| UC-04 | Cập nhật trạng thái sẵn sàng | Tài xế bật/tắt sẵn sàng       | ACT-02                         | FR05                   | BP-01               | BR_02                            | Đã xác nhận       |
| UC-05 | Đặt xe                       | Khách tạo, xem và hủy yêu cầu khi còn SEARCHING | ACT-01 | FR07, FR08, FR09, FR10 | BP-02 | — | Đã xác nhận       |
...
| UC-13 | Gửi và nhận thông báo        | Hệ thống phát sinh qua adapter; Khách hàng/Tài xế nhận, đọc và đồng bộ lại trạng thái | ACT-01, ACT-02, ACT-06 | FR38–FR43 | BP-02, BP-03, BP-04 | BR_15 | Đã xác nhận cho pilot |
...
| UC-16 | Quản lý vận hành             | Tra cứu khách hàng, tài xế, phương tiện, chuyến, giao dịch; duyệt hồ sơ và chỉ cập nhật trạng thái được phép | ACT-03, ACT-04 | FR48–FR53 | BP-06 | BR_18 | Đã xác nhận       |
| UC-17 | Xử lý sự cố                  | Tra cứu/xử lý lỗi             | ACT-03                         | FR52, FR53, FR54       | BP-06               | BR_18, EX06                      | Đã xác nhận       |
| UC-18 | Báo cáo hoạt động            | Ban lãnh đạo xem báo cáo; Admin có thể xem để kiểm tra nhưng không đại diện Ban lãnh đạo | ACT-04, ACT-07 | FR55–FR58 | BP-07 | — | Đã xác nhận actor; công thức hiệu suất TBD |
...
| AC-15 | Happy Path    | FR33      | UC-12 | Khách chọn tiền mặt                            | Tài xế xác nhận đã nhận tiền           | Ghi nhận thanh toán thành công                                   | BR_11           | Đã xác nhận       |
...
| AC-25 | Boundary      | FR46/FR47 | UC-15 | Khách sở hữu chuyến hoàn thành chưa quá 7 ngày | Gửi điểm nguyên 1–5 lần đầu            | Lưu một đánh giá; quá hạn, trùng hoặc điểm ngoài biên bị từ chối | BR_17/BR-06     | Baseline dự án    |
...
## 16.4 Boundary context và dữ liệu kiểm thử

Quy ước: số ở “ngay dưới/đúng ngưỡng/ngay trên” là dữ liệu thử, **không phải** thay đổi chính sách; thời điểm server quyết định ngưỡng. Với định dạng sai, thiếu field và lỗi phụ thuộc ngoài, lập test case riêng cho từng FR có liên quan.

| BC    | Ngữ cảnh, input kiểm thử                                                                                                    | Kết quả kỳ vọng và truy xuất                                                                                                                     |
| ----- | --------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| BC-01 | Tọa độ latitude -90 / 90 / -90.000001 / 90.000001; longitude -180 / 180 / 180.000001; null, NaN, chuỗi, điểm đón = điểm đến | Hai biên hợp lệ, ngoài biên và sai kiểu bị từ chối; cùng điểm bị từ chối. FR-07–08, FR-15, RULE-03.                                              |
| BC-02 | Bán kính 4.999 / 5.000 / 5.001 m tính từ điểm đón theo khoảng cách thẳng WGS84                                              | Hai giá trị đầu đủ điều kiện, cuối loại. FR-10, RULE-03.                                                                                         |
| BC-03 | Tuổi vị trí 59 / 60 / 61 giây; vị trí mới có timestamp cũ hơn bản đã lưu                                                    | 59/60 dùng, 61 bỏ; không ghi đè bản mới bằng bản cũ. FR-10, FR-15.                                                                               |
| BC-04 | Phản hồi ở 19.999 / 20.000 / 20.001 giây; 2 tài xế ACCEPT đồng thời                                                         | Hai đầu được xét nếu offer chưa kết thúc, >20 từ chối; đúng một tài xế được gán. FR-11–13, RULE-04.                                              |
| BC-05 | 9/10/11 ứng viên; điều phối ở 179/180/181 giây; không có ứng viên                                                           | Không mời hơn 10; dừng tại 180 giây hoặc khi hết ứng viên; yêu cầu NO_DRIVER, thông báo một lần. FR-11–14.                                       |
| BC-06 | Xe máy 0/2.000/2.001 m; ô tô 2.000/2.001 m; khoảng cách thiếu; dữ liệu ước tính/ thực khác nhau                             | ≤2 km trả giá mở cửa; 2.001 m cộng phần dư rồi làm tròn lên 1.000đ; thiếu tuyến dùng giá trị dự kiến đã lưu và gắn cờ. FR-06, FR-19–20, RULE-06. |
| BC-07 | 1 request gửi 2 lần cùng Idempotency-Key và payload; cùng khóa payload khác; 2 khóa khác khi khách đang SEARCHING           | Trường hợp 1 trả cùng ID, trường hợp 2 và 3 trả 409; chỉ một yêu cầu mở. FR-07–08.                                                               |
| BC-08 | Chuyển ARRIVED→PICKED_UP hợp lệ; ASSIGNED→MOVING, COMPLETED→CANCELLED; khách hủy trước/sau PICKED_UP                        | Chỉ nhánh hợp lệ được lưu; sau đón khách chuyển xử lý sự cố. FR-16–17, RULE-05.                                                                  |
| BC-09 | 0/1/2/3 lần thử lại sau thất bại; callback trùng; callback thành công đến sau timeout; yêu cầu thanh toán khi UNKNOWN       | Cho tối đa 2 lần khách thử lại, lần 3 từ chối; callback trùng không tạo thu đôi; UNKNOWN tra cứu trước khi cho thử. FR-23–25, RULE-07.           |
| BC-10 | Điểm rating 0/1/5/6/1.5; lúc 7 ngày - 1 giây / đúng 7 ngày / +1 giây; gửi lần hai                                           | 1 và 5 nguyên hợp lệ, đúng hạn hợp lệ; sai thang, quá hạn và gửi trùng bị từ chối. FR-29, RULE-08.                                               |
| BC-11 | Ngày đầu/cuối kỳ báo cáo; kỳ trống, mẫu số 0; doanh thu chuyến hoàn thành chưa thanh toán                                   | Đầu kỳ gồm/cuối kỳ loại, mẫu số 0 trả N/A, chưa trả không cộng doanh thu. FR-33, RULE-09.                                                        |
| BC-12 | `page` 0/1/1000/1001, `size` 0/1/100/101, khoảng ngày 366/367 ngày                                                          | Hai đầu hợp lệ theo mục 9, ngoài ngưỡng 400. FR-27–28, FR-30, FR-33.                                                                             |
| BC-13 | Token hết hạn, khách xem chuyến người khác, vận hành tự cấp quyền, lãnh đạo xem vị trí                                      | 401/404/403/403 tương ứng, không rò rỉ dữ liệu, không thay đổi dữ liệu. FR-18, FR-30–34.                                                         |
...
| BC-15 | Mất mạng trước/đúng sau khi server commit request, phản hồi offer, rating, payment                                          | Tra cứu trước gửi lại, giữ cùng khóa; dữ liệu cuối chỉ một bản ghi hoặc một kết quả hợp lệ. EX-05, NFR-02.                                       |
| BC-16 | Tài khoản bị khóa, phương tiện bị khóa, tài xế có chuyến mở, khách có yêu cầu mở                                            | Không bật ONLINE hoặc tạo yêu cầu thứ hai; lỗi trạng thái có mã, không thay đổi bản ghi. FR-05, FR-08.                                           |
...
> \*\*Chú ý chất lượng dữ liệu nguồn:\*\* bước 05 dùng BR-01–BR-30, trong khi một số ma trận sinh ở bước 12–17 dùng BR01–BR29 và FR01–FR62. Đây là hai đợt đánh số của tài liệu ban đầu, \*\*không tự coi BR01 = BR-01 hay FR01 = FR-01\*\*. Dùng tên nghiệp vụ và UC/FR ở phần tương ứng để đối chiếu trước khi sinh test tự động. Bảng BC mục 16.4 dẫn FR theo nghiệp vụ; không dùng số lượng BR để suy ra số test.

**NEED → STK → SCOPE → BR → BP → Step → FR → FR con → Rule/Exception → NFR → DATA → ACTOR/UC → AC**

> Ghi chú: SRS.md hiện dùng `BR01`–`BR29` (Business Requirement) và `BR\_01`–`BR\_22` (Business Rule). Trong RTM, cột `BR` là Business Requirement (BR01–BR29), cột `Rule` là Business Rule (BR_01–BR_22).
...
## 18.9 Chính sách triển khai API cho baseline 7 tuần

**Authentication:** Bearer access token có hạn 30 phút; refresh token 7 ngày, xoay khi cấp mới, lưu hash phía máy chủ; logout thu hồi refresh token. Endpoint ngoài đăng ký/đăng nhập/callback yêu cầu Bearer và role; callback xác thực chữ ký hoặc bí mật chia sẻ cấu hình riêng cho sandbox. Không đặt token trong URL. Đây là lựa chọn kỹ thuật của baseline, không phải BR khách hàng.

**Request:** JSON UTF-8; `Content-Type: application/json`; `Idempotency-Key` UUID bắt buộc cho POST tạo request/payment và POST phản hồi offer (giữ kết quả theo khóa và chủ thể 24 giờ; khác payload cùng khóa → 409). ID trong path UUID; list phân trang `page` 1–1000, `size` 1–100, mặc định 1/20; `from` bao gồm và `to` loại trừ, khoảng lọc tối đa 366 ngày. Không cho cập nhật trường trạng thái/tổng tiền bằng API hồ sơ hoặc client tự quyết định cước.

**Response:** lỗi chung `{code, message, details, requestId}`; `details` là mảng `{field, reason}`; thời gian ISO 8601 UTC. `400` sai schema/field, `401` chưa đăng nhập, `403` không quyền, `404` không tồn tại hoặc không sở hữu đối tượng riêng tư, `409` xung đột trạng thái/khóa, `422` dữ liệu hợp lệ về định dạng nhưng trái RULE, `429` vượt giới hạn tần suất, `500` lỗi nội bộ, `502/503` phụ thuộc ngoài lỗi/tạm ngưng. Client phải tra cứu trạng thái sau timeout, không suy diễn đã thất bại.

| UC    | Method / path ứng viên                                                                                                                                            | Request quan trọng                              | Thành công; lỗi đặc thù                         |
| ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------- | ----------------------------------------------- |
| UC-01 | POST `/api/v1/auth/register`; POST `/api/v1/auth/driver-registrations`                                                                                            | Khách: phone,name,password; tài xế: tài khoản+hồ sơ+phương tiện | 201 User / 201 DriverApplication; 409 dữ liệu trùng |
| UC-02 | POST `/api/v1/auth/login`; POST `/api/v1/auth/refresh`; POST `/api/v1/auth/logout`                                                                                | phone,password / refreshToken                   | 200 tokens / 204; 401                           |
| UC-03 | GET/PATCH `/api/v1/me/profile`; GET/PATCH `/api/v1/drivers/me/profile`; GET `/api/v1/drivers/me/vehicle`; POST `/api/v1/drivers/me/change-requests` | Tài khoản chung hoặc thay đổi nghiệp vụ cần duyệt | 200 Profile/Vehicle; 201 ChangeRequest; 409 xung đột |
| UC-04 | PATCH `/api/v1/drivers/me/availability`                                                                                                                           | availability                                    | 200 Driver; 409 đang có chuyến                  |
| UC-05 | POST `/api/v1/ride-requests`; GET `/api/v1/ride-requests/{id}`; POST `/api/v1/ride-requests/{id}/cancellation`                                                        | pickup,destination,vehicleType; Idempotency-Key | 201/200; hủy chỉ SEARCHING; 409 nếu trạng thái đã đổi |
| UC-06 | Nội bộ khi request SEARCHING                                                                                                                                      | Không cho client gọi dispatch tùy ý             | Kết quả thể hiện qua RideRequest và thông báo   |
| UC-07 | GET `/api/v1/drivers/me/offers`; POST `/api/v1/ride-offers/{id}/responses`                                                                                        | decision ACCEPT/DECLINE; Idempotency-Key        | 200 Offer/Trip; 409 hết hạn                     |
| UC-08 | PUT `/api/v1/drivers/me/location`                                                                                                                                 | latitude,longitude                              | 200 Location; 422 sai tọa độ                    |
| UC-09 | PATCH `/api/v1/trips/{id}/status`; POST `/api/v1/trips/{id}/cancellation`                                                                                         | status hoặc reason                              | 200 Trip; 409 chuyển sai                        |
| UC-10 | GET `/api/v1/trips/{id}`                                                                                                                                          | id                                              | 200 Trip+ETA hoặc null; 404 không sở hữu        |
| UC-11 | Nội bộ khi Trip COMPLETED; GET `/api/v1/trips/{id}/fare`                                                                                                          | Không nhận giá client                           | 200 Fare; 409 chưa hoàn thành                   |
| UC-12 | POST `/api/v1/trips/{id}/payments`; GET `/api/v1/trips/{id}/payments`; POST `/api/v1/payments/provider-callbacks`; POST `/api/v1/payments/{id}/cash-confirmation` | method; Idempotency-Key; callback xác thực      | 201/200; 409 đã trả/chưa xác định; 502 provider |
| UC-13 | GET `/api/v1/me/events`; GET `/api/v1/notifications`; PATCH `/api/v1/notifications/{id}`                                                                           | SSE + hộp thông báo in-app; PATCH read=true     | 200 stream/list/Notification; 404 khác chủ      |
| UC-14 | GET `/api/v1/me/trips`                                                                                                                                            | page,size,from,to                               | 200 paginated history                           |
| UC-15 | POST `/api/v1/trips/{id}/rating`                                                                                                                                  | score nguyên 1–5                                | 201 Rating; 409 trùng/hết hạn                   |
| UC-16 | GET Operations customers/drivers/vehicles/trips/transactions; GET/PATCH driver applications/change-requests; PATCH driver status; PATCH admin roles; POST admin fares | tra cứu, duyệt, trạng thái, danh sách role đích | 200/201; 403 ngoài quyền; không DELETE/sửa payment result |
| UC-17 | GET `/api/v1/operations/incidents`; PATCH `/api/v1/operations/incidents/{id}`                                                                                     | status,note                                     | 200 Incident; 409 xung đột                      |
| UC-18 | GET `/api/v1/reports/operations`                                                                                                                                  | from,to,groupBy DAY/MONTH                       | 200 metrics; 403 ngoài quyền                    |

**Tạo sự cố:** để UC-17 có nguồn sự cố, hệ thống tự tạo sự cố khi lỗi chuyến được báo qua `POST /api/v1/trips/{id}/incidents` bởi khách/tài xế của chuyến, `{reason,note?}`; vận hành có thể tạo hộ với actor/audit. `reason` enum `ROUTE/DRIVER/PASSENGER/OTHER`, `note` tối đa 500 ký tự. Đây là bổ sung baseline cần được đánh dấu khi triển khai API.

### 18.9.1 Quyết định bổ sung đã chốt cho contract theo actor

Các quyết định dưới đây có hiệu lực cao hơn các ô `\[Cần làm rõ]` cũ cùng chủ đề, nhưng không làm cho `FR01…FR62` và `FR-01…FR-38` trở thành cùng một hệ mã.

| Chủ đề | Quyết định và hậu điều kiện | Truy vết |
| --- | --- | --- |
| Đăng ký tài xế | Tài xế tự gửi hồ sơ. Kết quả ban đầu: đăng ký `PENDING_REVIEW`, tài khoản `PENDING_APPROVAL`, availability `OFFLINE`. Duyệt thành công kích hoạt tài khoản nhưng không tự bật nhận chuyến. | UC-01; FR-02; FR-03; FR-06 |
| Thay đổi hồ sơ tài xế | Tên/số điện thoại là tài khoản chung. Trường nghiệp vụ thông thường được cập nhật trực tiếp theo contract; giấy tờ/phương tiện tạo change request và chỉ có hiệu lực sau APPROVE. | UC-03; FR-06; FR-35 |
| Hủy RideRequest | Chỉ chủ sở hữu được hủy khi `SEARCHING`; hậu điều kiện `CANCELLED` và dừng matching. Khi hủy và nhận chuyến đồng thời, transaction được commit trước có hiệu lực; thao tác sau nhận 409. Khi đã `ASSIGNED`/có Trip, dùng hủy Trip. Phí hủy `TBD`. | UC-05; FR-08; FR-14 đến FR-16 |
| Thời gian thực | Dùng SSE `GET /api/v1/me/events` cho màn hình đang hoạt động. Sự kiện tối thiểu gồm eventId, eventType, resourceType, resourceId, occurredAt và status nếu có. Client có thể nối lại bằng `Last-Event-ID`, sau gián đoạn phải GET resource; API đọc là nguồn sự thật. Không cam kết SLA chưa có căn cứ. | UC-05 đến UC-10; UC-13; FR-09/12/15/16/18/21 |
| Notification Provider | Hệ thống gọi provider qua adapter nội bộ. API notification là hộp thư cho Customer/Driver; không công bố webhook provider trong pilot. | UC-13; FR-09/15/18/26/27 |
| Vận hành | OPERATOR được tra cứu customers, drivers, vehicles, trips và transactions; được duyệt hồ sơ/yêu cầu thay đổi và xử lý tác vụ đã nêu. Không DELETE dữ liệu, không sửa kết quả thanh toán. | UC-16/17; FR-31 đến FR-35 |
| Ban lãnh đạo | ACT-07/EXECUTIVE chỉ xem báo cáo được cấp. ADMIN có thể xem để kiểm tra nhưng quyền cấu hình của ADMIN không được suy ra cho EXECUTIVE. | UC-18; FR-36 đến FR-38 |
| Role | `PATCH /api/v1/admin/roles/{id}` thay thế toàn bộ tập role quản trị đích; tập rỗng thu hồi. Contract chỉ cho gán OPERATOR/EXECUTIVE, không tự cấp ADMIN. | UC-16; FR-31; FR-35; BRULE-12 đến 14 |
| Thanh toán | Chỉ mock/sandbox. Callback, chữ ký, retry, timeout và nhà cung cấp thật là `TBD`; không mô tả sandbox như tích hợp sản xuất. | UC-12; FR-24 đến FR-27 |

**Luồng thay thế/ngoại lệ bắt buộc:** hồ sơ bị từ chối giữ tài khoản chưa được nhận chuyến và lưu lý do; change request bị từ chối không đổi dữ liệu hiệu lực; tài xế `PENDING_APPROVAL` hoặc `SUSPENDED` không được chuyển availability sang ONLINE; SSE mất kết nối không làm thay đổi trạng thái nghiệp vụ; 401 dùng khi chưa xác thực, 403 khi role/quyền sở hữu không hợp lệ, 409 khi trạng thái đã đổi hoặc có xung đột đồng thời, 422 khi payload hợp lệ về cú pháp nhưng sai ràng buộc trường.

**TBD còn lại:** phí hủy, SLA/thời hạn xét duyệt, thời gian giữ/phát lại SSE, chi tiết lưu trữ giấy tờ, công thức `driverEfficiency`, kỳ báo cáo mặc định và contract nhà cung cấp thanh toán thật.

**Đối tác ngoài:** tên nhà cung cấp thanh toán thật, tài khoản sandbox, chữ ký callback theo đặc tả riêng của đối tác chỉ có thể chốt khi chọn đối tác; adapter mock và hợp đồng nội bộ ở bảng này là đủ để xây API document cho bản thí điểm. Không xuất bản contract callback của nhà cung cấp thật trước khi có tài liệu của họ.

**Đối chiếu mục 18.3:** endpoint dispatch là tác vụ nội bộ, không mở POST `/dispatch` cho client; cước sau hoàn thành cũng là tác vụ nội bộ. Các path ở bảng mục này là contract ứng viên cuối của bản thí điểm; các path `...` ở 18.3 chỉ là ứng viên phân tích.
...
SRS giữ nguyên chuỗi phân tích 02–18, đồng thời có baseline tại mục 05.IV, 08.V, 10.I.a, 12.9, 16.4, 18.9 và quyết định bổ sung tại 18.9.1. Với các bảng cũ ghi `\[NEED CLARIFICATION]` hoặc `\[Cần làm rõ]` ở cùng chủ đề, chính sách tại các mục baseline sau có hiệu lực ưu tiên cho API document và test case. Các mục còn `TBD` được liệt kê tại 18.9.1, không được tự biến thành yêu cầu chính thức. Bản thí điểm chỉ dùng payment mock/sandbox. Khi làm API/test, dẫn đồng thời BR → FR → Rule/Exception → UC → AC → BC và không tự đồng nhất hai hệ mã FR.
