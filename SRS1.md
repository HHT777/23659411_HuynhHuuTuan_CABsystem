...
> **Bản chuẩn hóa theo `cus.md` và chính sách vận hành cơ sở cho thị trường Việt Nam năm 2026.** Nội dung từ phần này trở đi là nguồn chính thức để phân tích nghiệp vụ. Mọi yêu cầu đi theo chuỗi: `Actor → Use Case → Functional Requirement (FR) → Business Rule/Exception → NFR`.
>
> Các chính sách cơ sở trong phần này được chọn để hệ thống có thể triển khai MVP trong 7 tuần. Đây là chính sách nghiệp vụ của phiên bản hiện tại, không phải khẳng định tuân thủ pháp luật hay cam kết SLA bên ngoài. Khi Công ty ABC ban hành chính sách chính thức, phải cập nhật các phần bị ảnh hưởng.
>
> Phần phân tích cũ ở phía sau được giữ lại để tham chiếu lịch sử và không được dùng làm nguồn chính thức nếu có khác biệt với bản chuẩn hóa này. Khi lập API Document, chỉ sử dụng Actor, Use Case, FR, Rule, NFR và chính sách cơ sở trong bản chuẩn hóa này.

---

## 1. Thông tin dự án và nguồn yêu cầu
...
| Nguồn nghiệp vụ                  | `cus.md`                                                                                                                                                  |
| Mục tiêu                         | Hỗ trợ quy trình từ tạo yêu cầu đặt xe, tìm/phân công tài xế, thực hiện chuyến, tính cước, thanh toán, thông báo đến đánh giá; hỗ trợ vận hành và báo cáo |

### 1.1. Nguyên tắc phân tích

- Chỉ đưa vào SRS nghiệp vụ có cơ sở trong `cus.md`.
- Không tạo Use Case hoặc FR chỉ vì có một Entity/database table.
- FR mô tả hệ thống phải làm gì; NFR mô tả chất lượng hoặc ràng buộc của chức năng đó.
- Các chính sách chưa được chốt phải giữ `[Cần làm rõ]`.
- Không coi đề xuất triển khai, API, database hoặc framework là FR.

## 2. Actor và hệ thống bên ngoài

| Actor ID | Actor                   | Loại                                    | Vai trò                                                                                              |
| -------- | ----------------------- | --------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| ACT-01   | Khách hàng              | Actor chính                             | Đăng ký, đăng nhập, đặt xe, theo dõi chuyến, thanh toán, xem lịch sử và đánh giá                     |
| ACT-02   | Tài xế                  | Actor chính                             | Quản lý hồ sơ/phương tiện, sẵn sàng nhận chuyến, nhận/từ chối chuyến, cập nhật trạng thái và vị trí  |
| ACT-03   | Nhân viên vận hành      | Actor chính                             | Quản lý khách hàng, tài xế, phương tiện, chuyến đi; giám sát, hỗ trợ chuyến lỗi và tra cứu giao dịch |
| ACT-04   | Ban lãnh đạo            | Stakeholder, không phải Actor trực tiếp | Nhận báo cáo do nhân viên vận hành cung cấp; không đăng nhập trực tiếp trong phiên bản này           |
| ACT-05   | Nhà cung cấp thanh toán | Hệ thống bên ngoài                      | Xử lý thanh toán điện tử qua cổng thanh toán hỗ trợ QR/ngân hàng điện tử hoặc ví điện tử             |
| ACT-06   | Nhà cung cấp thông báo  | Hệ thống bên ngoài                      | Hỗ trợ gửi thông báo đẩy; thông báo trong ứng dụng là kênh dự phòng bắt buộc                         |

## 3. Phạm vi nghiệp vụ

### 3.1. Trong phạm vi

1. Quản lý tài khoản và thông tin cá nhân.
2. Quản lý hồ sơ, phương tiện và trạng thái hoạt động của tài xế.
3. Tạo yêu cầu đặt xe với điểm đón, điểm đến và loại xe.
4. Tìm và phân công tài xế theo vị trí, trạng thái sẵn sàng và tiêu chí vận hành.
5. Xử lý tài xế không phản hồi hoặc từ chối và thông báo khi không tìm được tài xế.
6. Theo dõi vị trí, ETA và trạng thái chuyến.
7. Tính cước, thanh toán tiền mặt và thanh toán điện tử.
8. Thông báo các sự kiện đặt xe, chuyến đi và thanh toán.
9. Lịch sử chuyến, số tiền phải trả và đánh giá tài xế.
10. Quản trị, giám sát, hỗ trợ chuyến lỗi, tra cứu giao dịch và báo cáo.
11. Xác thực, phân quyền, bảo vệ dữ liệu và lưu vết thao tác quan trọng.

### 3.2. Ngoài trách nhiệm trực tiếp của CAB

- Không lưu trực tiếp dữ liệu nhạy cảm của thẻ hoặc tài khoản thanh toán.
- Áp dụng các chính sách cơ sở tại mục 3.3; chỉ các nội dung ngoài chính sách cơ sở mới cần xác nhận thêm với doanh nghiệp.
- AI, Big Data, Machine Learning, phân tích nâng cao và các module không được nêu trong `cus.md` không thuộc SRS này.

### 3.3. Chính sách cơ sở áp dụng cho phiên bản MVP

| Nhóm        | Chính sách cơ sở                                                                                                                                                                                                                                                                                       |
| ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Xác thực    | Đăng ký và đăng nhập bằng số điện thoại Việt Nam và mật khẩu; OTP chỉ dùng để xác minh số điện thoại hoặc khôi phục tài khoản. API dùng Bearer access token và refresh token.                                                                                                                          |
| Phân quyền  | Bốn vai trò: `CUSTOMER`, `DRIVER`, `OPERATOR`, `ADMIN`. Ban lãnh đạo nhận báo cáo qua vận hành, không phải Actor trực tiếp. `ADMIN` phê duyệt hoặc thực hiện thao tác nhạy cảm; `OPERATOR` chỉ làm thao tác được cấp quyền.                                                                            |
| Đặt xe      | Điểm đón/điểm đến lưu địa chỉ và tọa độ WGS84 nếu ứng dụng cung cấp; loại xe phải thuộc danh mục đang hoạt động.                                                                                                                                                                                       |
| Matching    | Chỉ chọn tài xế đang `AVAILABLE`, có phương tiện phù hợp và có vị trí hợp lệ trong khu vực phục vụ. Ưu tiên ETA gần nhất, sau đó khoảng cách; gửi tuần tự từng đề xuất. Mỗi đề xuất chờ 30 giây; từ chối hoặc hết thời gian thì chuyển tài xế tiếp theo. Hết danh sách thì kết thúc `NO_DRIVER_FOUND`. |
| Vị trí/ETA  | Tài xế gửi vị trí khi đang trực tuyến và đang nhận/thực hiện chuyến; khoảng cập nhật cơ sở là 10 giây. ETA là giá trị ước tính, có thể vắng mặt nếu không đủ dữ liệu định vị.                                                                                                                          |
| Cước        | Cước cơ sở gồm phí mở cửa, quãng đường, thời gian và loại dịch vụ; đơn vị tiền là VND; làm tròn đến 1.000 VND; không áp dụng phụ phí giờ cao điểm trong MVP nếu chưa có yêu cầu riêng.                                                                                                                 |
| Thanh toán  | Hỗ trợ tiền mặt và thanh toán điện tử qua cổng bên ngoài; ưu tiên QR/ngân hàng điện tử hoặc ví điện tử phổ biến tại Việt Nam. CAB chỉ lưu mã giao dịch, phương thức và trạng thái, không lưu dữ liệu thẻ/tài khoản. Giao dịch chưa rõ kết quả phải ở trạng thái `PENDING`, không tự ghi thành công.    |
| Retry       | Giao dịch thất bại cho phép khách hàng thực hiện lại tối đa 3 lần; không tự động trừ tiền lại khi giao dịch đang `PENDING`.                                                                                                                                                                            |
| Thông báo   | Thông báo trong ứng dụng là bắt buộc; thông báo đẩy là kênh chính khi thiết bị hỗ trợ. Sự kiện quan trọng vẫn phải lưu trong hộp thông báo để tra cứu.                                                                                                                                                 |
| Đánh giá    | Thang điểm 1–5 sao, nhận xét không bắt buộc; mỗi khách hàng chỉ đánh giá một lần cho mỗi chuyến trong vòng 30 ngày kể từ khi chuyến hoàn thành.                                                                                                                                                        |
| Mất kết nối | Request cập nhật có `Idempotency-Key`; client được phép thử lại tối đa 3 lần. Khi chưa biết kết quả, client truy vấn lại trạng thái thay vì tạo bản ghi mới.                                                                                                                                           |
| Báo cáo     | Báo cáo mặc định theo ngày, tuần và tháng; gồm chuyến, doanh thu đã ghi nhận, hoàn thành, hủy và hiệu quả tài xế. Nhân viên vận hành tạo/xem báo cáo; ban lãnh đạo nhận báo cáo từ vận hành.                                                                                                           |
| Audit       | Lưu người thực hiện, thời điểm, hành động, đối tượng và kết quả đối với đăng nhập, phân quyền, thay đổi hồ sơ, thay đổi chuyến, giao dịch và xử lý sự cố.                                                                                                                                              |

Các chính sách trên là baseline để triển khai MVP; không tạo thêm Use Case cho hủy chuyến, khôi phục dữ liệu hoặc quản lý kênh thông báo riêng vì `cus.md` không mô tả thao tác tương ứng.

## 4. Use Case tổng thể

| UC ID | Use Case                                        | Actor chính                      | Mục tiêu                                                | FR liên quan                      |
| ----- | ----------------------------------------------- | -------------------------------- | ------------------------------------------------------- | --------------------------------- |
| UC-01 | Đăng ký tài khoản khách hàng                    | ACT-01                           | Tạo tài khoản khách hàng                                | FR-01, FR-02                      |
| UC-02 | Đăng ký hoặc tạo tài khoản tài xế               | ACT-02, ACT-03                   | Tạo tài khoản/hồ sơ tài xế                              | FR-03, FR-04                      |
| UC-03 | Đăng nhập                                       | ACT-01, ACT-02, ACT-03           | Xác thực người dùng                                     | FR-05                             |
| UC-04 | Cập nhật thông tin cá nhân                      | ACT-01                           | Cập nhật thông tin cá nhân khách hàng                   | FR-06                             |
| UC-05 | Quản lý hồ sơ, phương tiện và trạng thái tài xế | ACT-02, ACT-03                   | Quản lý thông tin tài xế và trạng thái hoạt động        | FR-07, FR-08, FR-09               |
| UC-06 | Tạo yêu cầu đặt xe                              | ACT-01                           | Gửi yêu cầu gồm điểm đón, điểm đến, loại xe             | FR-10, FR-11                      |
| UC-07 | Tìm tài xế phù hợp                              | Hệ thống; ACT-02 nhận đề xuất    | Tìm tài xế theo vị trí, trạng thái và tiêu chí vận hành | FR-12, FR-13, FR-14               |
| UC-08 | Tài xế nhận hoặc từ chối chuyến                 | ACT-02                           | Phản hồi đề xuất chuyến                                 | FR-15, FR-16                      |
| UC-09 | Thông báo kết quả phân công                     | Hệ thống; ACT-01, ACT-02 nhận    | Thông báo tài xế nhận chuyến hoặc không tìm được tài xế | FR-17, FR-18                      |
| UC-10 | Cập nhật vị trí tài xế                          | ACT-02                           | Lưu vị trí để hỗ trợ matching và ETA                    | FR-19                             |
| UC-11 | Cập nhật trạng thái chuyến                      | ACT-02                           | Cập nhật đã đến, đã đón, đang di chuyển, hoàn thành     | FR-20, FR-21, FR-22, FR-23        |
| UC-12 | Theo dõi chuyến                                 | ACT-01                           | Xem tài xế, ETA và trạng thái hiện tại                  | FR-24, FR-25                      |
| UC-13 | Tính cước                                       | Hệ thống                         | Xác định số tiền phải trả sau khi chuyến hoàn thành     | FR-26                             |
| UC-14 | Thanh toán chuyến                               | ACT-01; ACT-05                   | Thanh toán tiền mặt hoặc điện tử và ghi nhận kết quả    | FR-27, FR-28, FR-29, FR-30        |
| UC-15 | Gửi thông báo sự kiện                           | Hệ thống; ACT-01, ACT-02, ACT-06 | Gửi thông báo về các sự kiện nghiệp vụ                  | FR-31, FR-32, FR-33, FR-34, FR-35 |
| UC-16 | Xem lịch sử chuyến và số tiền phải trả          | ACT-01                           | Tra cứu lịch sử sau chuyến                              | FR-36, FR-37                      |
| UC-17 | Đánh giá tài xế                                 | ACT-01                           | Đánh giá sau khi chuyến hoàn thành                      | FR-38                             |
| UC-18 | Quản lý và giám sát vận hành                    | ACT-03                           | Quản lý đối tượng, giám sát chuyến và tài xế            | FR-39, FR-40, FR-41, FR-42        |
| UC-19 | Hỗ trợ chuyến lỗi và tra cứu giao dịch          | ACT-03                           | Hỗ trợ sự cố và tra cứu lịch sử giao dịch               | FR-43, FR-44                      |
| UC-20 | Quản lý quyền và audit                          | ACT-03                           | Kiểm soát thao tác nhạy cảm và lưu vết                  | FR-45, FR-46                      |
| UC-21 | Báo cáo hoạt động                               | ACT-03                           | Cung cấp số liệu chuyến, doanh thu và hiệu quả tài xế   | FR-47, FR-48, FR-49, FR-50        |

## 5. Functional Requirement theo Use Case

### 5.1. UC-01 — Đăng ký tài khoản khách hàng

| FR ID | Functional Requirement                                                | Nguồn                       | Trạng thái                                                 |
| ----- | --------------------------------------------------------------------- | --------------------------- | ---------------------------------------------------------- |
| FR-01 | Hệ thống cho phép khách hàng cung cấp thông tin để đăng ký tài khoản. | cus.md - yêu cầu khách hàng | Đã xác nhận                                                |
| FR-02 | Hệ thống tạo tài khoản khách hàng khi thông tin đăng ký hợp lệ.       | UC-01                       | Đã xác nhận; số điện thoại và mật khẩu là dữ liệu bắt buộc |

### 5.2. UC-02 — Đăng ký hoặc tạo tài khoản tài xế

| FR ID | Functional Requirement                                                                    | Nguồn                   | Trạng thái                                                  |
| ----- | ----------------------------------------------------------------------------------------- | ----------------------- | ----------------------------------------------------------- |
| FR-03 | Hệ thống cho phép tài xế đăng ký hoặc cho phép nhân viên vận hành tạo tài khoản tài xế.   | cus.md - yêu cầu tài xế | Đã xác nhận                                                 |
| FR-04 | Hệ thống lưu hồ sơ tài xế do tài xế hoặc nhân viên vận hành cung cấp theo quyền được cấp. | UC-02                   | Đã xác nhận; quyền theo vai trò `DRIVER`/`OPERATOR`/`ADMIN` |

### 5.3. UC-03 — Đăng nhập

| FR ID | Functional Requirement                                                                                                                 | Nguồn            | Trạng thái                                                        |
| ----- | -------------------------------------------------------------------------------------------------------------------------------------- | ---------------- | ----------------------------------------------------------------- |
| FR-05 | Hệ thống xác thực thông tin đăng nhập của người dùng và từ chối thông tin không hợp lệ trước khi cho dùng chức năng yêu cầu tài khoản. | cus.md - bảo mật | Đã xác nhận; số điện thoại/mật khẩu, OTP xác minh và Bearer token |

### 5.4. UC-04 — Cập nhật thông tin cá nhân

| FR ID | Functional Requirement                                                  | Nguồn                       | Trạng thái                                                   |
| ----- | ----------------------------------------------------------------------- | --------------------------- | ------------------------------------------------------------ |
| FR-06 | Hệ thống cho phép khách hàng cập nhật thông tin cá nhân của chính mình. | cus.md - yêu cầu khách hàng | Đã xác nhận; cập nhật họ tên và thông tin liên hệ đã đăng ký |

### 5.5. UC-05 — Quản lý hồ sơ, phương tiện và trạng thái tài xế

| FR ID | Functional Requirement                                                                                             | Nguồn                         | Trạng thái                                                  |
| ----- | ------------------------------------------------------------------------------------------------------------------ | ----------------------------- | ----------------------------------------------------------- |
| FR-07 | Hệ thống cho phép tài xế cập nhật hồ sơ tài xế.                                                                    | cus.md - yêu cầu tài xế       | Đã xác nhận                                                 |
| FR-08 | Hệ thống cho phép tài xế hoặc nhân viên vận hành cập nhật thông tin phương tiện theo quyền được cấp.               | cus.md - hồ sơ/phương tiện    | Đã xác nhận; một tài xế có thể quản lý phương tiện được gán |
| FR-09 | Hệ thống cho phép tài xế chuyển trạng thái hoạt động sang sẵn sàng nhận chuyến hoặc trạng thái khác được xác nhận. | cus.md - trạng thái hoạt động | Đã xác nhận; trạng thái `AVAILABLE` và `OFFLINE`            |

### 5.6. UC-06 — Tạo yêu cầu đặt xe

| FR ID | Functional Requirement                                           | Nguồn                | Trạng thái                                  |
| ----- | ---------------------------------------------------------------- | -------------------- | ------------------------------------------- |
| FR-10 | Hệ thống cho phép khách hàng nhập điểm đón, điểm đến và loại xe. | cus.md - đặt xe      | Đã xác nhận                                 |
| FR-11 | Hệ thống tiếp nhận và ghi nhận yêu cầu đặt xe của khách hàng.    | cus.md - gửi yêu cầu | Đã xác nhận; địa chỉ và tọa độ WGS84 nếu có |

### 5.7. UC-07 — Tìm tài xế phù hợp

| FR ID | Functional Requirement                                                                                                        | Nguồn                   | Trạng thái                                                                |
| ----- | ----------------------------------------------------------------------------------------------------------------------------- | ----------------------- | ------------------------------------------------------------------------- |
| FR-12 | Hệ thống xác định tài xế phù hợp dựa trên vị trí, trạng thái sẵn sàng và các tiêu chí vận hành được doanh nghiệp xác nhận.    | cus.md - matching       | Đã xác nhận; `AVAILABLE`, phương tiện phù hợp và vị trí hợp lệ            |
| FR-13 | Hệ thống ưu tiên tài xế phù hợp và gần khách hàng theo chính sách được xác nhận.                                              | cus.md - ưu tiên tài xế | Đã xác nhận; ưu tiên ETA gần nhất, sau đó khoảng cách                     |
| FR-14 | Hệ thống tiếp tục tìm tài xế khác khi tài xế được đề xuất không phản hồi hoặc từ chối mà không yêu cầu khách tạo lại yêu cầu. | cus.md - matching       | Đã xác nhận; chờ 30 giây mỗi đề xuất, hết danh sách thì `NO_DRIVER_FOUND` |

### 5.8. UC-08 — Tài xế nhận hoặc từ chối chuyến

| FR ID | Functional Requirement                                                 | Nguồn                   | Trạng thái                                                     |
| ----- | ---------------------------------------------------------------------- | ----------------------- | -------------------------------------------------------------- |
| FR-15 | Hệ thống gửi thông tin yêu cầu chuyến phù hợp đến tài xế được đề xuất. | cus.md - yêu cầu tài xế | Đã xác nhận; push notification và hộp thông báo trong ứng dụng |
| FR-16 | Hệ thống ghi nhận việc tài xế chấp nhận hoặc từ chối chuyến.           | cus.md - yêu cầu tài xế | Đã xác nhận; thời gian chờ đề xuất là 30 giây                  |

### 5.9. UC-09 — Thông báo kết quả phân công

| FR ID | Functional Requirement                                               | Nguồn                          | Trạng thái                               |
| ----- | -------------------------------------------------------------------- | ------------------------------ | ---------------------------------------- |
| FR-17 | Hệ thống thông báo cho khách hàng khi tài xế nhận chuyến.            | cus.md - thông báo             | Đã xác nhận; in-app và push notification |
| FR-18 | Hệ thống thông báo rõ ràng cho khách hàng khi không tìm được tài xế. | cus.md - không tìm được tài xế | Đã xác nhận                              |

### 5.10. UC-10 — Cập nhật vị trí tài xế

| FR ID | Functional Requirement                                                                     | Nguồn                  | Trạng thái                                                                      |
| ----- | ------------------------------------------------------------------------------------------ | ---------------------- | ------------------------------------------------------------------------------- |
| FR-19 | Hệ thống lưu thông tin vị trí tài xế để hỗ trợ tìm tài xế gần khách hàng và cải thiện ETA. | cus.md - vị trí tài xế | Đã xác nhận; tọa độ WGS84, cập nhật cơ sở 10 giây khi trực tuyến/đang có chuyến |

### 5.11. UC-11 — Cập nhật trạng thái chuyến

| FR ID | Functional Requirement                                          | Nguồn                      | Trạng thái  |
| ----- | --------------------------------------------------------------- | -------------------------- | ----------- |
| FR-20 | Hệ thống cho phép tài xế cập nhật trạng thái đã đến điểm đón.   | cus.md - trạng thái chuyến | Đã xác nhận |
| FR-21 | Hệ thống cho phép tài xế cập nhật trạng thái đã đón khách.      | cus.md - trạng thái chuyến | Đã xác nhận |
| FR-22 | Hệ thống cho phép tài xế cập nhật trạng thái đang di chuyển.    | cus.md - trạng thái chuyến | Đã xác nhận |
| FR-23 | Hệ thống cho phép tài xế cập nhật trạng thái hoàn thành chuyến. | cus.md - trạng thái chuyến | Đã xác nhận |

### 5.12. UC-12 — Theo dõi chuyến

| FR ID | Functional Requirement                                                              | Nguồn                    | Trạng thái                                                                |
| ----- | ----------------------------------------------------------------------------------- | ------------------------ | ------------------------------------------------------------------------- |
| FR-24 | Hệ thống cung cấp cho khách hàng thông tin tài xế đã nhận chuyến.                   | cus.md - theo dõi chuyến | Đã xác nhận                                                               |
| FR-25 | Hệ thống cung cấp trạng thái chuyến và thời gian dự kiến tài xế đến cho khách hàng. | cus.md - ETA/trạng thái  | Đã xác nhận; ETA là giá trị ước tính và có thể vắng mặt khi thiếu dữ liệu |

### 5.13. UC-13 — Tính cước

| FR ID | Functional Requirement                                                                                                | Nguồn              | Trạng thái                                                                                |
| ----- | --------------------------------------------------------------------------------------------------------------------- | ------------------ | ----------------------------------------------------------------------------------------- |
| FR-26 | Hệ thống xác định số tiền khách hàng phải trả sau khi chuyến hoàn thành dựa trên loại dịch vụ và thông tin chuyến đi. | cus.md - tính cước | Đã xác nhận; cước cơ sở + quãng đường + thời gian + loại dịch vụ, VND, làm tròn 1.000 VND |

### 5.14. UC-14 — Thanh toán chuyến

| FR ID | Functional Requirement                                                                                                 | Nguồn                        | Trạng thái                                                                         |
| ----- | ---------------------------------------------------------------------------------------------------------------------- | ---------------------------- | ---------------------------------------------------------------------------------- |
| FR-27 | Hệ thống cho phép khách hàng chọn thanh toán bằng tiền mặt hoặc phương thức điện tử được hỗ trợ.                       | cus.md - thanh toán          | Đã xác nhận; tiền mặt hoặc QR/ngân hàng điện tử/ví điện tử                         |
| FR-28 | Hệ thống phối hợp với nhà cung cấp thanh toán bên ngoài để xử lý thanh toán điện tử.                                   | cus.md - provider thanh toán | Đã xác nhận; cổng thanh toán bên ngoài, chỉ lưu mã giao dịch và trạng thái         |
| FR-29 | Hệ thống ghi nhận kết quả thanh toán và thông báo kết quả cho khách hàng.                                              | cus.md - kết quả thanh toán  | Đã xác nhận                                                                        |
| FR-30 | Khi thanh toán điện tử thất bại, hệ thống thông báo cho khách hàng và cho phép xử lý lại theo chính sách doanh nghiệp. | cus.md - retry thanh toán    | Đã xác nhận; khách được thử lại tối đa 3 lần, giao dịch `PENDING` không tự thu lại |

### 5.15. UC-15 — Gửi thông báo sự kiện

| FR ID | Functional Requirement                                                                         | Nguồn                      | Trạng thái                                                    |
| ----- | ---------------------------------------------------------------------------------------------- | -------------------------- | ------------------------------------------------------------- |
| FR-31 | Hệ thống thông báo cho khách hàng khi yêu cầu đặt xe được tiếp nhận.                           | cus.md - thông báo         | Đã xác nhận; thông báo trong ứng dụng và push notification    |
| FR-32 | Hệ thống thông báo cho khách hàng khi tài xế đến điểm đón và khi chuyến hoàn thành.            | cus.md - thông báo         | Đã xác nhận; thông báo trong ứng dụng và push notification    |
| FR-33 | Hệ thống thông báo cho khách hàng khi thanh toán có kết quả.                                   | cus.md - thông báo         | Đã xác nhận; lưu trong hộp thông báo và gửi push notification |
| FR-34 | Hệ thống thông báo cho tài xế về chuyến mới hoặc thay đổi liên quan đến chuyến đang thực hiện. | cus.md - thông báo tài xế  | Đã xác nhận; lưu trong hộp thông báo và gửi push notification |
| FR-35 | Hệ thống hỗ trợ mở rộng thêm kênh hoặc nhà cung cấp thông báo trong tương lai.                 | cus.md - mở rộng thông báo | Đã xác nhận về định hướng; phiên bản MVP dùng push + in-app   |

### 5.16. UC-16 — Xem lịch sử chuyến và số tiền phải trả

| FR ID | Functional Requirement                                               | Nguồn                    | Trạng thái                                                                                |
| ----- | -------------------------------------------------------------------- | ------------------------ | ----------------------------------------------------------------------------------------- |
| FR-36 | Hệ thống lưu thông tin chuyến đã hoàn thành để phục vụ lịch sử.      | cus.md - lịch sử chuyến  | Đã xác nhận                                                                               |
| FR-37 | Hệ thống cho phép khách hàng xem lịch sử chuyến và số tiền phải trả. | cus.md - lịch sử/số tiền | Đã xác nhận; mặc định tra cứu theo khoảng thời gian và dữ liệu còn trong thời hạn lưu trữ |

### 5.17. UC-17 — Đánh giá tài xế

| FR ID | Functional Requirement                                                  | Nguồn             | Trạng thái                                                     |
| ----- | ----------------------------------------------------------------------- | ----------------- | -------------------------------------------------------------- |
| FR-38 | Hệ thống cho phép khách hàng đánh giá tài xế sau khi chuyến hoàn thành. | cus.md - đánh giá | Đã xác nhận; 1–5 sao, nhận xét tùy chọn, một lần trong 30 ngày |

### 5.18. UC-18 — Quản lý và giám sát vận hành

| FR ID | Functional Requirement                                                                                    | Nguồn                      | Trạng thái                                 |
| ----- | --------------------------------------------------------------------------------------------------------- | -------------------------- | ------------------------------------------ |
| FR-39 | Hệ thống cho phép nhân viên vận hành quản lý thông tin khách hàng theo quyền được cấp.                    | cus.md - quản trị          | Đã xác nhận; theo quyền `OPERATOR`/`ADMIN` |
| FR-40 | Hệ thống cho phép nhân viên vận hành quản lý thông tin tài xế theo quyền được cấp.                        | cus.md - quản trị          | Đã xác nhận; theo quyền `OPERATOR`/`ADMIN` |
| FR-41 | Hệ thống cho phép nhân viên vận hành quản lý thông tin phương tiện theo quyền được cấp.                   | cus.md - quản trị          | Đã xác nhận; theo quyền `OPERATOR`/`ADMIN` |
| FR-42 | Hệ thống cho phép nhân viên vận hành quản lý chuyến đi và xem các chuyến đang diễn ra, trạng thái tài xế. | cus.md - giám sát vận hành | Đã xác nhận; theo quyền `OPERATOR`/`ADMIN` |

### 5.19. UC-19 — Hỗ trợ chuyến lỗi và tra cứu giao dịch

| FR ID | Functional Requirement                                                                   | Nguồn                      | Trạng thái                                                     |
| ----- | ---------------------------------------------------------------------------------------- | -------------------------- | -------------------------------------------------------------- |
| FR-43 | Hệ thống cho phép nhân viên vận hành tiếp nhận và hỗ trợ xử lý trường hợp chuyến bị lỗi. | cus.md - chuyến lỗi        | Đã xác nhận; ghi nhận sự cố và chuyển `ADMIN` nếu vượt quyền   |
| FR-44 | Hệ thống cho phép nhân viên vận hành tra cứu lịch sử giao dịch.                          | cus.md - tra cứu giao dịch | Đã xác nhận; lọc theo mã giao dịch, chuyến và khoảng thời gian |

### 5.20. UC-20 — Quản lý quyền và audit

| FR ID | Functional Requirement                                                     | Nguồn            | Trạng thái                                                      |
| ----- | -------------------------------------------------------------------------- | ---------------- | --------------------------------------------------------------- |
| FR-45 | Hệ thống kiểm soát quyền truy cập đối với các thao tác quản trị nhạy cảm.  | cus.md - bảo mật | Đã xác nhận; bốn vai trò baseline và nguyên tắc deny-by-default |
| FR-46 | Hệ thống lưu vết các thao tác quan trọng để phục vụ kiểm tra khi có sự cố. | cus.md - audit   | Đã xác nhận; actor, thời điểm, hành động, đối tượng và kết quả  |

### 5.21. UC-21 — Báo cáo hoạt động

| FR ID | Functional Requirement                                        | Nguồn            | Trạng thái                                                        |
| ----- | ------------------------------------------------------------- | ---------------- | ----------------------------------------------------------------- |
| FR-47 | Hệ thống cung cấp báo cáo về số lượng chuyến.                 | cus.md - báo cáo | Đã xác nhận; theo ngày, tuần và tháng                             |
| FR-48 | Hệ thống cung cấp báo cáo về doanh thu.                       | cus.md - báo cáo | Đã xác nhận; doanh thu đã ghi nhận theo ngày, tuần và tháng       |
| FR-49 | Hệ thống cung cấp tỷ lệ chuyến hoàn thành và tỷ lệ hủy.       | cus.md - báo cáo | Đã xác nhận; tỷ lệ tính trên tổng yêu cầu trong kỳ                |
| FR-50 | Hệ thống cung cấp thông tin về hiệu quả hoạt động của tài xế. | cus.md - báo cáo | Đã xác nhận; số chuyến, tỷ lệ hoàn thành và tỷ lệ hủy theo tài xế |

## 6. Quy tắc nghiệp vụ và ngoại lệ chính

| Rule/Exception | Nội dung                                                                                                                      | UC ảnh hưởng    |
| -------------- | ----------------------------------------------------------------------------------------------------------------------------- | --------------- |
| BR-01          | Người dùng phải được xác thực trước chức năng yêu cầu tài khoản.                                                              | UC-03 đến UC-21 |
| BR-02          | Chỉ tài xế `AVAILABLE`, có phương tiện phù hợp và vị trí hợp lệ mới được đề xuất chuyến.                                      | UC-07, UC-08    |
| BR-03          | Khi tài xế từ chối hoặc không phản hồi trong 30 giây, hệ thống tiếp tục tìm tài xế khác.                                      | UC-07, UC-08    |
| BR-04          | Nếu không tìm được tài xế, khách hàng phải được thông báo rõ ràng với trạng thái `NO_DRIVER_FOUND`.                           | UC-09           |
| BR-05          | Trạng thái chuyến phải phản ánh các mốc đã đến, đã đón, đang di chuyển, hoàn thành theo đúng thứ tự.                          | UC-11, UC-12    |
| BR-06          | Thanh toán điện tử phải thông qua nhà cung cấp bên ngoài; CAB không lưu dữ liệu nhạy cảm.                                     | UC-14           |
| BR-07          | Lỗi thanh toán hoặc thông báo không được làm toàn bộ quy trình đặt xe dừng hoạt động; giao dịch chưa rõ kết quả là `PENDING`. | UC-14, UC-15    |
| BR-08          | Thao tác quản trị nhạy cảm phải được kiểm soát quyền và thao tác quan trọng phải được lưu vết.                                | UC-18 đến UC-20 |

Các chính sách cơ sở đã được chốt trong mục 3.3. Chỉ yêu cầu thay đổi các chính sách đó, yêu cầu ngoài phạm vi MVP hoặc yêu cầu tuân thủ pháp lý/đối tác cụ thể mới cần xác nhận bổ sung.

## 7. Yêu cầu phi chức năng

| NFR ID | Nhóm            | Yêu cầu                                                                                                                 | FR/UC liên quan                                         | Trạng thái                                                     |
| ------ | --------------- | ----------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------- | -------------------------------------------------------------- |
| NFR-01 | Security        | Chức năng yêu cầu tài khoản chỉ được sử dụng sau khi xác thực.                                                          | FR-05, UC-03                                            | Đã xác nhận                                                    |
| NFR-02 | Security        | Thao tác quản trị nhạy cảm phải bị từ chối nếu không có quyền phù hợp.                                                  | FR-45, UC-20                                            | Đã xác nhận; áp dụng bốn vai trò baseline                      |
| NFR-03 | Security        | Không lưu trực tiếp dữ liệu thanh toán nhạy cảm trong CAB.                                                              | FR-28, UC-14                                            | Đã xác nhận                                                    |
| NFR-04 | Security        | Thông tin cá nhân, phương tiện, vị trí và giao dịch phải được bảo vệ.                                                   | FR-06, FR-08, FR-19, FR-44                              | Đã xác nhận; tuân theo quyền truy cập và audit baseline        |
| NFR-05 | Security        | Thao tác quan trọng phải có thông tin người thực hiện và thời điểm để kiểm tra.                                         | FR-46, UC-20                                            | Đã xác nhận; lưu các trường audit baseline                     |
| NFR-06 | Reliability     | Lỗi thanh toán hoặc thông báo không được làm toàn bộ quy trình đặt xe ngừng hoạt động.                                  | FR-30, FR-33, FR-34                                     | Đã xác nhận; lỗi phải cô lập và giao dịch chưa rõ là `PENDING` |
| NFR-07 | Performance     | Hệ thống phải hoạt động ổn định khi nhu cầu tăng cao và phục vụ số lượng lớn.                                           | FR-11, FR-12, FR-24, FR-47                              | Đã xác nhận baseline; chỉ tiêu cao hơn cần xác nhận bổ sung    |
| NFR-08 | Maintainability | Có thể bổ sung dịch vụ, phương thức thanh toán, kênh thông báo hoặc thay đổi thành phần kỹ thuật với ảnh hưởng hạn chế. | FR-28, FR-35                                            | Đã xác nhận định hướng; MVP dùng push + in-app                 |
| NFR-09 | Reliability     | Phải có cách xử lý khi mất kết nối mạng.                                                                                | Các FR cập nhật yêu cầu, vị trí, trạng thái và đánh giá | Đã xác nhận baseline; retry/idempotency theo mục 3.3           |

## 8. Ma trận truy xuất Use Case → FR
...
| UC-03 | FR-05                             |
| UC-04 | FR-06                             |
| UC-05 | FR-07, FR-08, FR-09               |
| UC-06 | FR-10, FR-11                      |
| UC-07 | FR-12, FR-13, FR-14               |
| UC-08 | FR-15, FR-16                      |
| UC-09 | FR-17, FR-18                      |
| UC-10 | FR-19                             |
| UC-11 | FR-20, FR-21, FR-22, FR-23        |
| UC-12 | FR-24, FR-25                      |
| UC-13 | FR-26                             |
| UC-14 | FR-27, FR-28, FR-29, FR-30        |
| UC-15 | FR-31, FR-32, FR-33, FR-34, FR-35 |
| UC-16 | FR-36, FR-37                      |
| UC-17 | FR-38                             |
| UC-18 | FR-39, FR-40, FR-41, FR-42        |
| UC-19 | FR-43, FR-44                      |
| UC-20 | FR-45, FR-46                      |
| UC-21 | FR-47, FR-48, FR-49, FR-50        |

## 9. Danh sách cần làm rõ

| ID    | Nội dung cần xác nhận bổ sung                                                        | Use Case/FR ảnh hưởng                       |
| ----- | ------------------------------------------------------------------------------------ | ------------------------------------------- |
| CL-01 | Công thức/biểu phí chính thức của Công ty ABC nếu khác baseline cước tại mục 3.3     | UC-13, FR-26                                |
| CL-02 | Danh mục loại xe/dịch vụ và khu vực phục vụ thực tế                                  | UC-05, UC-06, FR-08, FR-10, FR-12           |
| CL-03 | Tên/contract cụ thể của cổng thanh toán và yêu cầu đối soát                          | UC-14, FR-28 đến FR-30                      |
| CL-04 | Tài khoản gửi push notification và yêu cầu thương hiệu/nội dung thông báo            | UC-09, UC-15, FR-15, FR-17, FR-31 đến FR-35 |
| CL-05 | Ma trận quyền chi tiết nếu khác bốn vai trò baseline                                 | UC-18 đến UC-21, FR-39 đến FR-50            |
| CL-06 | Chỉ tiêu tải/SLA chính thức và ưu tiên bàn giao nếu doanh nghiệp yêu cầu cao hơn MVP | NFR-07, toàn hệ thống                       |
| CL-07 | Yêu cầu tuân thủ pháp lý, lưu trữ hoặc audit riêng của Công ty ABC                   | FR-19, FR-37, FR-44, FR-46                  |

Các nội dung đã được chốt theo baseline MVP gồm: Bearer token, vai trò, matching 30 giây, tọa độ WGS84/10 giây, cước VND làm tròn 1.000, retry tối đa 3 lần, push + in-app, đánh giá 1–5 sao trong 30 ngày, Idempotency-Key và báo cáo ngày/tuần/tháng.

## 10. Trạng thái SRS

SRS đã xác định đầy đủ Actor, 21 Use Case và 50 FR theo nội dung `cus.md`, đồng thời đã áp dụng baseline MVP cho các chính sách nghiệp vụ phổ biến. Các FR đều truy xuất được về Use Case và nguồn nghiệp vụ. Chỉ các mục CL còn lại mới cần Công ty ABC xác nhận bổ sung trước khi thay đổi API Contract.

---

# PHỤ LỤC — PHÂN TÍCH CŨ

> Phần nội dung phía dưới là bản phân tích trước đây. Nếu có khác biệt về số lượng, mã Use Case, mã FR hoặc diễn giải nghiệp vụ, ưu tiên các mục 1–10 ở đầu file vì chúng đã được chuẩn hóa trực tiếp theo `cus.md`.
...
### I.A. Các Functional Requirement bổ sung FR-39 đến FR-62

Các FR dưới đây bổ sung những chức năng đã được sử dụng trong các phần Data, Actor/Use Case, Acceptance Criteria, RTM và tài liệu NFR. Chúng không tạo nghiệp vụ mới; nội dung được chuẩn hóa từ các hoạt động, Business Rule, Exception và Use Case đã có. Các chính sách chưa được xác nhận vẫn giữ `[Cần làm rõ]`.

| FR ID | Functional Requirement                                                                                                             | BR liên quan        | BP liên quan    | Step liên quan                     | Đối tượng sử dụng      | Trạng thái                                                              |
| ----- | ---------------------------------------------------------------------------------------------------------------------------------- | ------------------- | --------------- | ---------------------------------- | ---------------------- | ----------------------------------------------------------------------- |
| FR-39 | Hệ thống tạo chuyến và gán tài xế khi tài xế chấp nhận đề xuất chuyến hợp lệ.                                                      | BR-04, BR-12        | BP-03           | STEP-08                            | STK-01, STK-02         | Đã xác nhận                                                             |
| FR-40 | Hệ thống cập nhật trạng thái yêu cầu đặt xe sau khi có kết quả tìm và phân công tài xế.                                            | BR-04, BR-11        | BP-03           | STEP-09, STEP-10                   | STK-01, STK-02         | Đã xác nhận; trạng thái chi tiết `[Cần làm rõ]`                         |
| FR-41 | Hệ thống phát sinh thông báo khi yêu cầu đặt xe được tiếp nhận.                                                                    | BR-18               | BP-02           | STEP-06                            | STK-01                 | Đã xác nhận; kênh `[Cần làm rõ]`                                        |
| FR-42 | Hệ thống phát sinh thông báo khi có kết quả thanh toán.                                                                            | BR-18, BR-20        | BP-05           | STEP-17                            | STK-01                 | Đã xác nhận; kênh `[Cần làm rõ]`                                        |
| FR-43 | Hệ thống ghi nhận trạng thái gửi thông báo cho các sự kiện nghiệp vụ đã xác định.                                                  | BR-18, BR-19, BR-20 | BP-02 đến BP-05 | STEP-06, STEP-10, STEP-11, STEP-17 | STK-01, STK-02         | Đã xác nhận; kênh và chính sách gửi `[Cần làm rõ]`                      |
| FR-44 | Hệ thống cung cấp danh sách lịch sử chuyến của khách hàng.                                                                         | BR-05               | BP-06           | STEP-18, STEP-19                   | STK-01                 | Đã xác nhận                                                             |
| FR-45 | Hệ thống cung cấp số tiền phải trả gắn với chuyến trong lịch sử.                                                                   | BR-05, BR-15        | BP-05, BP-06    | STEP-15, STEP-19                   | STK-01                 | Đã xác nhận; công thức cước `[Cần làm rõ]`                              |
| FR-46 | Hệ thống tiếp nhận điểm đánh giá và nhận xét của khách hàng đối với tài xế sau chuyến.                                             | BR-06               | BP-06           | STEP-20                            | STK-01                 | Đã xác nhận; thang điểm `[Cần làm rõ]`                                  |
| FR-47 | Hệ thống lưu đánh giá gắn với chuyến và tài xế sau khi đáp ứng điều kiện đánh giá.                                                 | BR-06               | BP-06           | STEP-20                            | STK-01                 | Đã xác nhận; điều kiện/thời hạn `[Cần làm rõ]`                          |
| FR-48 | Hệ thống cho phép nhân viên vận hành tra cứu và quản lý thông tin khách hàng theo quyền được cấp.                                  | BR-21, BR-23        | BP-07           | STEP-21, STEP-22                   | STK-03                 | Đã xác nhận; ma trận quyền `[Cần làm rõ]`                               |
| FR-49 | Hệ thống cho phép nhân viên vận hành tra cứu và quản lý thông tin tài xế theo quyền được cấp.                                      | BR-21, BR-23        | BP-07           | STEP-21, STEP-22                   | STK-03                 | Đã xác nhận; ma trận quyền `[Cần làm rõ]`                               |
| FR-50 | Hệ thống cho phép nhân viên vận hành tra cứu và quản lý thông tin phương tiện theo quyền được cấp.                                 | BR-21, BR-23        | BP-07           | STEP-21, STEP-22                   | STK-03                 | Đã xác nhận; quan hệ tài xế/phương tiện và ma trận quyền `[Cần làm rõ]` |
| FR-51 | Hệ thống cho phép nhân viên vận hành tra cứu và quản lý thông tin chuyến đi theo quyền được cấp.                                   | BR-21, BR-23        | BP-07           | STEP-21, STEP-22                   | STK-03                 | Đã xác nhận; ma trận quyền `[Cần làm rõ]`                               |
| FR-52 | Hệ thống cho phép nhân viên vận hành xem các chuyến đang diễn ra và trạng thái tài xế.                                             | BR-22               | BP-07           | STEP-22                            | STK-03                 | Đã xác nhận                                                             |
| FR-53 | Hệ thống cho phép nhân viên vận hành tiếp nhận thông tin chuyến lỗi để hỗ trợ xử lý.                                               | BR-22               | BP-07           | STEP-23                            | STK-03                 | Đã xác nhận; kết quả xử lý `[Cần làm rõ]`                               |
| FR-54 | Hệ thống cho phép nhân viên vận hành tra cứu lịch sử giao dịch và thực hiện thao tác được cấp quyền.                               | BR-22, BR-23        | BP-07           | STEP-23                            | STK-03                 | Đã xác nhận; thao tác và ma trận quyền `[Cần làm rõ]`                   |
| FR-55 | Hệ thống tổng hợp số lượng chuyến theo phạm vi báo cáo được xác định.                                                              | BR-24               | BP-08           | STEP-25, STEP-26                   | STK-03, STK-04, STK-05 | Đã xác nhận; định nghĩa và kỳ báo cáo `[Cần làm rõ]`                    |
| FR-56 | Hệ thống tổng hợp doanh thu theo phạm vi báo cáo được xác định.                                                                    | BR-24               | BP-08           | STEP-25, STEP-26                   | STK-03, STK-04, STK-05 | Đã xác nhận; định nghĩa và kỳ báo cáo `[Cần làm rõ]`                    |
| FR-57 | Hệ thống tổng hợp tỷ lệ hoàn thành và tỷ lệ hủy chuyến theo phạm vi báo cáo được xác định.                                         | BR-24               | BP-08           | STEP-25, STEP-26                   | STK-03, STK-04, STK-05 | Đã xác nhận; chính sách hủy và cách tính `[Cần làm rõ]`                 |
| FR-58 | Hệ thống cung cấp thông tin về hiệu quả hoạt động của tài xế trong báo cáo.                                                        | BR-24               | BP-08           | STEP-25, STEP-26                   | STK-04, STK-05         | Đã xác nhận; định nghĩa chỉ số và kỳ báo cáo `[Cần làm rõ]`             |
| FR-59 | Hệ thống xác thực thông tin đăng nhập của người dùng và từ chối thông tin không hợp lệ.                                            | BR-27               | BP-01           | STEP-02                            | STK-01, STK-02, STK-03 | Đã xác nhận; cơ chế xác thực `[Cần làm rõ]`                             |
| FR-60 | Hệ thống kiểm tra quyền trước khi cho phép thực hiện thao tác quản trị hoặc thao tác nhạy cảm.                                     | BR-23               | BP-07           | STEP-21, STEP-22, STEP-24          | STK-03, STK-04         | Đã xác nhận; ma trận role/permission `[Cần làm rõ]`                     |
| FR-61 | Hệ thống lưu vết người thực hiện và thời điểm của các thao tác quan trọng để phục vụ kiểm tra sự cố.                               | BR-29               | BP-07           | STEP-24                            | STK-03, STK-05         | Đã xác nhận; danh sách thao tác và thời hạn `[Cần làm rõ]`              |
| FR-62 | Hệ thống phối hợp với nhà cung cấp thanh toán bên ngoài mà không lưu trực tiếp dữ liệu nhạy cảm của thẻ hoặc tài khoản thanh toán. | BR-17, BR-28        | BP-05           | STEP-16, STEP-17                   | STK-05, STK-06         | Đã xác nhận; provider và contract `[Cần làm rõ]`                        |

FR-39 đến FR-62 là các FR cấp cao bổ sung để hoàn thiện chuỗi truy xuất. Các FR có nội dung chi tiết hơn trong FR-10, FR-21, FR-25, FR-32, FR-34 và FR-37 vẫn phải giữ quan hệ FR cha → FR con đã xác định ở bước 09.

## II. Nguồn và cấu trúc chi tiết của các FR

Mỗi FR-01 đến FR-62 trong danh sách trên có chuỗi truy xuất `NEED → STK → SCOPE → BR → BP → Step → FR`. Các FR được đánh dấu `[Suy ra]` là FR tối thiểu cần thiết để thực hiện kết quả đã xác nhận, cụ thể:
...
| FR-39 đến FR-47 | SCOPE-03, SCOPE-05, SCOPE-06           | Có             | Có đối với chính sách trạng thái, cước và đánh giá | Cần làm rõ một phần          | Giữ lại, xác nhận contract nghiệp vụ   |
| FR-48 đến FR-54 | SCOPE-07, SCOPE-08                     | Có             | Có đối với phân hệ vận hành rộng                   | Cần làm rõ                   | Giữ lại, xác nhận quyền và thao tác    |
| FR-55 đến FR-58 | SCOPE-07, SCOPE-09                     | Có             | Có                                                 | Cần làm rõ chỉ số/kỳ báo cáo | Giữ lại, xác nhận định nghĩa báo cáo   |
| FR-59 đến FR-62 | SCOPE-05, SCOPE-07, SCOPE-08           | Có             | Có đối với xác thực, audit và tích hợp thanh toán  | Cần làm rõ                   | Giữ lại, xác nhận cơ chế và chính sách |
...
FR-10, FR-21, FR-25, FR-32, FR-34, FR-37 và FR-38 đã được phân rã thành 23 FR con, giữ nguyên nguồn BR/BP/Step/Stakeholder. Các FR-39 đến FR-62 không tạo thêm FR con trong bước này vì đã được mô tả ở mức chức năng cần thiết.

### FR không cần phân rã

55 FR còn lại được giữ nguyên vì đã mô tả chức năng đơn nhất hoặc việc tách tiếp sẽ tạo thao tác nhỏ không làm tăng khả năng kiểm tra.
...
| Vấn đề còn cần xác nhận | Thông tin đang thiếu                        | API/Use Case bị ảnh hưởng | Thông tin cần bổ sung                   |
| ----------------------- | ------------------------------------------- | ------------------------- | --------------------------------------- |
| Biểu phí chính thức     | Công thức của Công ty ABC nếu khác baseline | UC-11, UC-12              | Biểu phí, phụ phí và hiệu lực           |
| Danh mục dịch vụ        | Loại xe, dịch vụ và khu vực phục vụ         | UC-05, UC-06              | Danh mục và trạng thái hoạt động        |
| Thanh toán đối soát     | Tên provider và yêu cầu đối soát            | UC-12                     | Contract, webhook và quy trình đối soát |
| Thông báo thương hiệu   | Tài khoản provider và nội dung template     | UC-13                     | Cấu hình gửi và template chính thức     |
| Quyền mở rộng           | Quyền khác baseline bốn vai trò             | UC-16, UC-17, UC-18       | Ma trận permission                      |
| SLA/tải cao hơn MVP     | Chỉ tiêu chính thức nếu có                  | Toàn hệ thống             | P95, tải đồng thời và ưu tiên bàn giao  |
| Lưu trữ pháp lý         | Yêu cầu riêng của doanh nghiệp/pháp lý      | History, Payment, Audit   | Thời hạn và phạm vi lưu trữ             |

API Document được phép phát hành theo baseline MVP tại mục 3.3. Chỉ các nội dung trong bảng 18.9 mới giữ `[NEED CLARIFICATION]`; các endpoint liên quan phải ghi rõ đang dùng chính sách baseline hay chờ chính sách riêng của doanh nghiệp.
